...
public final class SlotType {
   ...
   * Note that you will also want to define a texture for the creative modifier and JEI using {@link modernmods.hilt.client.model.NBTKeyModel#registerExtraTexture(Identifier, String, Identifier)}

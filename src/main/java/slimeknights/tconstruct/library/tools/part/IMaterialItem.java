...
public interface IMaterialItem extends ItemLike {
   ...
   */
  default slimeknights.mantle.recipe.helper.ItemOutput withMaterialForDisplayOutput(MaterialVariantId material) {
    net.minecraft.nbt.CompoundTag tag = new net.minecraft.nbt.CompoundTag();
    tag.putString(MATERIAL_TAG, material.toString());
    return slimeknights.mantle.recipe.helper.ItemOutput.fromItem(this.asItem(), 1, tag);
  }
